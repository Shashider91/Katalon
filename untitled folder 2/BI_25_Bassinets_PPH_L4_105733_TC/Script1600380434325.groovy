...
WS.sendRequest(findTestObject('BABY CATEGORY/BASIC_ITEM/01_Request_POST/BI_25_Bassinets_PPH_L4_105733_TC01', [('B_Name') : ''
            , ('B_ParentID') : a, ('B_WSL_AT_ProductDescriptionWebstore') : a, ('B_WSL_AT_OnlineDeliveryMinimumDays') : a
            ...
            , ('B_AT_BarcodeType') : a, ('B_AT_ProductBarcodeNumber') : a, ('B_AT_BarcodeFormat') : '']))
