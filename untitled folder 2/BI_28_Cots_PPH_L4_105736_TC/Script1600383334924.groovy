...
WS.sendRequest(findTestObject('BABY CATEGORY/BASIC_ITEM/01_Request_POST/BI_28_Cots_PPH_L4_105736_TC01', [('B_Name') : a, ('B_ParentID') : a
            , ('B_WSL_AT_ProductDescriptionWebstore') : a, ('B_WSL_AT_OnlineDeliveryMinimumDays') : a, ('B_WSL_AT_SoldOnlineIndicator') : a
            , ('B_WSL_AT_OnlineDeliveryMaximumDays') : a, ('B_WSL_AT_WebEnabled') : a, ('B_WSL_AT_OnlineDeliverySizeOverride') : a
            , ('B_WSL_AT_OnlineDeliverySizeDefault') : a, ('B_WSL_AT_WebItemSku') : a, ('B_WSL_AT_WebExpiryDate') : a, ('B_WSL_AT_FeaturesAndBenefits') : a
            , ('B_WSL_AT_ClickAndCollectFlag') : a, ('B_WSL_AT_WebClearanceIndicator') : a, ('B_WSL_AT_WebEffectiveDate') : a
            , ('B_TWL_AT_ProductDescriptionWebstore') : a, ('B_TWL_AT_OnlineDeliveryMinimumDays') : a, ('B_TWL_AT_SoldOnlineIndicator') : a
            , ('B_TWL_AT_OnlineDeliveryMaximumDays') : a, ('B_TWL_AT_WebEnabled') : a, ('B_TWL_AT_OnlineDeliverySizeOverride') : a
            , ('B_TWL_AT_OnlineDeliverySizeDefault') : a, ('B_TWL_AT_WebItemSku') : a, ('B_TWL_AT_WebExpiryDate') : a, ('B_TWL_AT_FeaturesAndBenefits') : a
            , ('B_TWL_AT_ClickAndCollectFlag') : a, ('B_TWL_AT_WebClearanceIndicator') : a, ('B_TWL_AT_WebEffectiveDate') : a
            , ('B_AT_ProductName') : a, ('B_AT_ProductShortName') : a, ('B_AT_DangerousGoodsTransportIndicator') : a, ('B_AT_InStoreEndDate') : a
            , ('B_AT_InStoreStartDate') : a, ('B_AT_ParallelImportCode') : a, ('B_AT_PreOrderAvailable') : a, ('B_AT_ProductImageURLIndicator') : a
            , ('B_AT_SupplierCode') : a, ('B_AT_HighRiskIndicator') : a, ('B_AT_PackagingFormat') : a, ('B_AT_RecallStatus') : a
            , ('B_AT_ProductStatus') : a, ('B_AT_ShippingProductDepth') : a, ('B_AT_ShippingProductHeight') : a, ('B_AT_ShippingProductVolume') : a
            , ('B_AT_ShippingProductWeight') : a, ('B_AT_ShippingProductWidth') : a, ('B_AT_TUIProductKey') : a, ('B_AT_TUIItemKey') : a
            , ('B_AT_BestBeforeDateIndicator') : a, ('B_AT_Character') : a, ('B_AT_License') : a, ('B_AT_Size') : a, ('B_DC_BarcodeType') : a
            , ('B_AT_ProductBarcode') : a, ('B_AT_BarcodeType') : a, ('B_AT_ProductBarcodeNumber') : a, ('B_AT_BarcodeFormat') : a]))
