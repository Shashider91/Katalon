...
WS.sendRequest(findTestObject('BABY CATEGORY/BASIC_ITEM/01_Request_POST/BI_34_Baby_Gift_Sets_PPH_L4_105742_TC01', [('B_Name') : '\r\n'
            , ('B_ParentID') : '', ('B_WSL_AT_ProductDescriptionWebstore') : '\r\n', ('B_WSL_AT_OnlineDeliveryMinimumDays') : ''
            , ('B_WSL_AT_SoldOnlineIndicator') : '', ('B_WSL_AT_OnlineDeliveryMaximumDays') : '', ('B_WSL_AT_WebEnabled') : ''
            , ('B_WSL_AT_OnlineDeliverySizeOverride') : '', ('B_WSL_AT_OnlineDeliverySizeDefault') : '', ('B_WSL_AT_WebItemSku') : ''
            , ('B_WSL_AT_WebExpiryDate') : '', ('B_WSL_AT_FeaturesAndBenefits') : '', ('B_WSL_AT_ClickAndCollectFlag') : ''
            , ('B_WSL_AT_WebClearanceIndicator') : '', ('B_WSL_AT_WebEffectiveDate') : '', ('B_TWL_AT_ProductDescriptionWebstore') : ''
            , ('B_TWL_AT_OnlineDeliveryMinimumDays') : '', ('B_TWL_AT_SoldOnlineIndicator') : '', ('B_TWL_AT_OnlineDeliveryMaximumDays') : ''
            , ('B_TWL_AT_WebEnabled') : '', ('B_TWL_AT_OnlineDeliverySizeOverride') : '', ('B_TWL_AT_OnlineDeliverySizeDefault') : ''
            , ('B_TWL_AT_WebItemSku') : '', ('B_TWL_AT_WebExpiryDate') : '', ('B_TWL_AT_FeaturesAndBenefits') : '', ('B_TWL_AT_ClickAndCollectFlag') : ''
            , ('B_TWL_AT_WebClearanceIndicator') : '', ('B_TWL_AT_WebEffectiveDate') : '', ('B_AT_ProductName') : '', ('B_AT_ProductShortName') : ''
            , ('B_AT_DangerousGoodsTransportIndicator') : '', ('B_AT_InStoreEndDate') : '', ('B_AT_InStoreStartDate') : ''
            , ('B_AT_ParallelImportCode') : '', ('B_AT_PreOrderAvailable') : '', ('B_AT_ProductImageURLIndicator') : '', ('B_AT_SupplierCode') : ''
            , ('B_AT_HighRiskIndicator') : '', ('B_AT_PackagingFormat') : '', ('B_AT_RecallStatus') : '', ('B_AT_ProductStatus') : ''
            , ('B_AT_ShippingProductDepth') : '', ('B_AT_ShippingProductHeight') : '', ('B_AT_ShippingProductVolume') : ''
            , ('B_AT_ShippingProductWeight') : '', ('B_AT_ShippingProductWidth') : '', ('B_AT_TUIProductKey') : '', ('B_AT_TUIItemKey') : ''
            , ('B_AT_BestBeforeDateIndicator') : '', ('B_AT_Character') : '', ('B_AT_License') : '', ('B_AT_Size') : '', ('B_DC_BarcodeType') : ''
            , ('B_AT_ProductBarcode') : '', ('B_AT_BarcodeType') : '', ('B_AT_ProductBarcodeNumber') : '', ('B_AT_BarcodeFormat') : '']))
