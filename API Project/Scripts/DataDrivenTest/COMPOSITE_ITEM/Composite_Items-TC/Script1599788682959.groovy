...
WS.sendRequest(findTestObject('COMPOSITE_ITEM/UPLOAD AND INVOKE/01_Request_POST/Composite_Item_Request_TC01', [('C_Name') : C_Name
            ...
            , ('C_AT_iPhoneModel') : C_AT_iPhoneModel, ('C_AT_MusicGenre') : C_AT_MusicGenre, ('C_AT_OperatingSystem') : C_AT_OperatingSystem
            , ('C_AT_PrinterType') : C_AT_PrinterType, ('C_AT_BedSize') : C_AT_BedSize, ('C_AT_BroadSpectrumCover') : C_AT_BroadSpectrumCover
            , ('C_AT_ChristmasDecorationType') : C_AT_ChristmasDecorationType, ('C_AT_ChristmasDesign') : C_AT_ChristmasDesign
            , ('C_AT_ChristmasProduct') : C_AT_ChristmasProduct, ('C_AT_GiftOccasion') : C_AT_GiftOccasion, ('C_AT_GiftingRecipient') : C_AT_GiftingRecipient
            , ('C_AT_ProductDepth') : C_AT_ProductDepth, ('C_AT_ProductDiameter') : C_AT_ProductDiameter, ('C_AT_ProductHeight') : C_AT_ProductHeight
            , ('C_AT_ProductLength') : C_AT_ProductLength, ('C_AT_ProductType') : C_AT_ProductType, ('C_AT_ProductVolume') : C_AT_ProductVolume
            , ('C_AT_ProductWeight') : C_AT_ProductWeight, ('C_AT_ProductWidth') : C_AT_ProductWidth, ('C_AT_SunProtectionFactor') : C_AT_SunProtectionFactor
            , ('C_AT_WarrantyPeriod') : C_AT_WarrantyPeriod, ('C_AT_WaterResistantCover') : C_AT_WaterResistantCover, ('C_AT_DeliveryDate') : C_AT_DeliveryDate
            , ('C_AT_DeliveryLocation') : C_AT_DeliveryLocation, ('C_AT_HalloweenProduct') : C_AT_HalloweenProduct, ('C_AT_PetType') : C_AT_PetType
            , ('C_AT_CandleType') : C_AT_CandleType, ('C_AT_ChairType') : C_AT_ChairType, ('C_AT_CutleryType') : C_AT_CutleryType
            , ('C_AT_DeskType') : C_AT_DeskType, ('C_AT_DimensionalShape') : C_AT_DimensionalShape, ('C_AT_EnergyEfficiencyRating') : C_AT_EnergyEfficiencyRating
            , ('C_AT_Ergonomic') : C_AT_Ergonomic, ('C_AT_FillType') : C_AT_FillType, ('C_AT_FurnitureStyle') : C_AT_FurnitureStyle
            , ('C_AT_HeatingorCooling') : C_AT_HeatingorCooling, ('C_AT_HomeFragrance') : C_AT_HomeFragrance, ('C_AT_Mattresstype') : C_AT_Mattresstype
            , ('C_AT_PrintIndicator') : C_AT_PrintIndicator, ('C_AT_PrintorPattern') : C_AT_PrintorPattern, ('C_AT_RugType') : C_AT_RugType
            , ('C_AT_TableandChairSettings') : C_AT_TableandChairSettings, ('C_AT_TowelType') : C_AT_TowelType, ('C_AT_Usesuitability') : C_AT_Usesuitability
            , ('C_AT_WaterEfficiencyRating') : C_AT_WaterEfficiencyRating, ('C_AT_AdditivesType') : C_AT_AdditivesType, ('C_AT_CleaningAccessoryType') : C_AT_CleaningAccessoryType
            , ('C_AT_CoverType') : C_AT_CoverType, ('C_AT_EngineOilType') : C_AT_EngineOilType, ('C_AT_GPS') : C_AT_GPS, ('C_AT_OutdoorFurnitureMaterial') : C_AT_OutdoorFurnitureMaterial
...
C_AT_SchooltexProductType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_SchooltexProductType.value.valueId', C_AT_SchooltexProductType, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_FabricContent != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_FabricContent.value.value', C_AT_FabricContent, FailureHandling.CONTINUE_ON_FAILURE): null

C_AT_LegalAgeRestriction != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_LegalAgeRestriction.values.valueId', C_AT_LegalAgeRestriction, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_ArtistorAuthor != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_ArtistorAuthor.value.valueId', C_AT_ArtistorAuthor, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_MultimediaPackSize != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_MultimediaPackSize.value.value', C_AT_MultimediaPackSize, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_NewReleaseExpiryDate != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_NewReleaseExpiryDate.value.value', C_AT_NewReleaseExpiryDate, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_CalculatorType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_CalculatorType.values[0].valueId', C_AT_CalculatorType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_GamingSoftwareType!= '' ? WS.verifyElementPropertyValue(rs, 'values.AT_GamingSoftwareType.value.valueId', C_GamingSoftwareType, FailureHandling.CONTINUE_ON_FAILURE): Null

C_AT_HeadphoneType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_HeadphoneType.values[0].valueId', C_AT_HeadphoneType, FailureHandling.CONTINUE_ON_FAILURE): null

C_AT_HPSureSupplySKUCode != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_HPSureSupplySKUCode.value.valueId', C_AT_HPSureSupplySKUCode, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_OperatingSystem != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_OperatingSystem.values.valueId', C_AT_OperatingSystem, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_PrinterType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_PrinterType.values[0].valueId', C_AT_PrinterType, FailureHandling.CONTINUE_ON_FAILURE) : null 
...
C_AT_BroadSpectrumCover != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_BroadSpectrumCover.values[0].valueId', C_AT_BroadSpectrumCover, FailureHandling.CONTINUE_ON_FAILURE): null 

C_AT_ChristmasDecorationType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_ChristmasDecorationType.values.valueId', C_AT_ChristmasDecorationType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_SunProtectionFactor != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_SunProtectionFactor.values.valueId', C_AT_SunProtectionFactor, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_WarrantyPeriod != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_WarrantyPeriod.values.valueId', C_AT_WarrantyPeriod, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_WaterResistantCover != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_WaterResistantCover.values.valueId', C_AT_WaterResistantCover, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_DeliveryLocation != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_DeliveryLocation.values.valueId', C_AT_DeliveryLocation, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_CutleryType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_CutleryType.values[0].valueId', C_AT_CutleryType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_DimensionalShape != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_DimensionalShape.values[0].valueId', C_AT_DimensionalShape, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_EnergyEfficiencyRating != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_EnergyEfficiencyRating.values.valueId', C_AT_EnergyEfficiencyRating, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_FurnitureStyle != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_FurnitureStyle.values.valueId', C_AT_FurnitureStyle, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_HeatingorCooling != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_HeatingorCooling.values.valueId', C_AT_HeatingorCooling, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_HomeFragrance != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_HomeFragrance.values[0].valueId', C_AT_HomeFragrance, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_Mattresstype != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_Mattresstype.values.valueId', C_AT_Mattresstype, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_PrintIndicator != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_PrintIndicator.values.valueId', C_AT_PrintIndicator, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_PrintorPattern != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_PrintorPattern.values[0].valueId', C_AT_PrintorPattern, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_TableandChairSettings != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_Table&amp;ChairSettings.values[0].valueId', C_AT_TableandChairSettings, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_Usesuitability != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_Usesuitability.values[0].valueId', C_AT_Usesuitability, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_WaterEfficiencyRating != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_WaterEfficiencyRating.values.valueId', C_AT_WaterEfficiencyRating, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_AdditivesType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_AdditivesType.values.valueId', C_AT_AdditivesType, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_CleaningAccessoryType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_CleaningAccessoryType.values.valueId', C_AT_CleaningAccessoryType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_EngineOilType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_EngineOilType.values.valueId', C_AT_EngineOilType, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_GPS != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_GPS.values.valueId', C_AT_GPS, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_OutdoorFurnitureMaterial != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_OutdoorFurnitureMaterial.values[0].valueId', C_AT_OutdoorFurnitureMaterial, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_PaperorCardType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_PaperorCardType.values.valueId', C_AT_PaperorCardType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_ActivityUse != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_ActivityUse.values[0].valueId', C_AT_ActivityUse, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_BookCoverType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_BookCoverType.values.valueId', C_AT_BookCoverType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_EnvelopeType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_EnvelopeType.values.valueId', C_AT_EnvelopeType, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_ExerciseBookLineType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_ExerciseBookLineType.values[0].valueId', C_AT_ExerciseBookLineType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_PaintBrushType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_PaintBrushType.values.valueId', C_AT_PaintBrushType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_ReportCoverType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_ReportCoverType.values.valueId', C_AT_ReportCoverType, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_RingBinderType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_RingBinderType.values.valueId', C_AT_RingBinderType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_StationeryBookType != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_StationeryBookType.values.valueId', C_AT_StationeryBookType, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_STEAMSubject != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_STEAMSubject.values[0].valueId', C_AT_STEAMSubject, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_WhiteboardType != '' ?  WC_AT_WhiteboardTypeS.verifyElementPropertyValue(rs, 'values.AT_WhiteboardType.values.valueId', C_AT_WhiteboardType, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_CableConnections != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_CableConnections.values[0].valueId', C_AT_CableConnections, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_ConnectionPort != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_ConnectionPort.values[0].value', C_AT_ConnectionPort, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_IMEIRequired != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_IMEIRequired.values.valueId', C_AT_IMEIRequired, FailureHandling.CONTINUE_ON_FAILURE) : null

C_AT_InkandTonerColours != '' ?  WS.verifyElementPropertyValue(rs, 'values."AT_Ink&amp;TonerColours".values[0].valueId', C_AT_InkandTonerColours, FailureHandling.CONTINUE_ON_FAILURE) : null
...
C_AT_TelcoNetwork != '' ?  WS.verifyElementPropertyValue(rs, 'values.AT_TelcoNetwork.values[0].valueId', C_AT_TelcoNetwork, FailureHandling.CONTINUE_ON_FAILURE) : null
