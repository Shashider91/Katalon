...
WS.sendRequest(findTestObject('BASIC_ITEM/UPLOAD AND INVOKE/01_Request_POST/Basic_Item_Request_TC01(old)', [('B_Name') : B_Name
            ...
            , ('B_TWL_AT_WebEffectiveDate') : B_TWL_AT_WebEffectiveDate, ('B_AT_DangerousGoodsTransportIndicator') : B_AT_DangerousGoodsTransportIndicator
            , ('B_AT_HighRiskIndicator') : B_AT_HighRiskIndicator, ('B_AT_InStoreEndDate') : B_AT_InStoreEndDate, ('B_AT_InStoreStartDate') : B_AT_InStoreStartDate
            , ('B_AT_PackagingFormat') : B_AT_PackagingFormat, ('B_AT_ParallelImportCode') : B_AT_ParallelImportCode, ('B_AT_PreOrderAvailable') : B_AT_PreOrderAvailable
            , ('B_AT_ProductImageURLIndicator') : B_AT_ProductImageURLIndicator, ('B_AT_ProductName') : B_AT_ProductName
            , ('B_AT_ProductShortName') : B_AT_ProductShortName, ('B_AT_ProductStatus') : B_AT_ProductStatus, ('B_AT_RecallStatus') : B_AT_RecallStatus
            , ('B_AT_ShippingProductDepth') : B_AT_ShippingProductDepth, ('B_AT_ShippingProductHeight') : B_AT_ShippingProductHeight
            , ('B_AT_ShippingProductVolume') : B_AT_ShippingProductVolume, ('B_AT_ShippingProductWeight') : B_AT_ShippingProductWeight
            , ('B_AT_ShippingProductWidth') : B_AT_ShippingProductWidth, ('B_AT_SupplierCode') : B_AT_SupplierCode, ('B_AT_TUIItemKey') : B_AT_TUIItemKey
            , ('B_AT_TUIProductKey') : B_AT_TUIProductKey, ('B_AT_AssemblyAttribute') : B_AT_AssemblyAttribute, ('B_AT_BestBeforeDateIndicator') : B_AT_BestBeforeDateIndicator
            ...
            , ('B_AT_iPhoneModel') : B_AT_iPhoneModel, ('B_AT_MusicGenre') : B_AT_MusicGenre, ('B_AT_PrinterType') : B_AT_PrinterType
            , ('B_DC_BarcodeType') : B_DC_BarcodeType, ('B_AT_ProductBarcode') : B_AT_ProductBarcode, ('B_AT_BarcodeType') : B_AT_BarcodeType
            , ('B_AT_ProductBarcodeNumber') : B_AT_ProductBarcodeNumber, ('B_AT_BarcodeFormat') : B_AT_BarcodeFormat]))
...
// WS.verifyElementPropertyValue(rs, 'values.AT_Age.value.valueId', B_AT_Age, FailureHandling.CONTINUE_ON_FAILURE)
...
WS.verifyElementPropertyValue(rs, 'values.AT_ProductStatus.value.valueId', B_AT_ProductStatus, FailureHandling.CONTINUE_ON_FAILURE)
...
WS.verifyElementPropertyValue(rs, 'values.AT_SchooltexProductType.value.valueId', B_AT_SchooltexProductType, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_FabricContent.values[0].value', B_AT_FabricContent, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_LegalAgeRestriction.values.valueId', B_AT_LegalAgeRestriction, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_GSTExempt.value.valueId', B_AT_GSTExempt, FailureHandling.CONTINUE_ON_FAILURE)
...
WS.verifyElementPropertyValue(rs, 'values.AT_ArtistorAuthor.value.valueId', B_AT_ArtistorAuthor, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_BookGenre.value.valueId', B_AT_BookGenre, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_MultimediaPackSize.value.valueId', B_AT_MultimediaPackSize, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_NewRelease.value.valueId', B_AT_NewRelease, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_NewReleaseExpiryDate.value.valueId', B_AT_NewReleaseExpiryDate, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_CalculatorType.value.valueId', B_AT_CalculatorType, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_DVDGenre.value.valueId', B_AT_DVDGenre, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_GameGenre.value.valueId', B_AT_GameGenre, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_GamingSoftwareType.value.valueId', B_GamingSoftwareType, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_HeadphoneType.values[0].valueId', B_AT_HeadphoneType, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_HPSureSupplySKUCode.value.valueId', B_AT_HPSureSupplySKUCode, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_iPhoneModel.value.valueId', B_AT_iPhoneModel, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_MusicGenre.value.valueId', B_AT_MusicGenre, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_OperatingSystem.value.valueId', B_AT_OperatingSystem, FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyElementPropertyValue(rs, 'values.AT_PrinterType.values[0].valueId', B_AT_PrinterType, FailureHandling.CONTINUE_ON_FAILURE)
...
WS.verifyElementPropertyValue(rs, 'values.AT_BarcodeType.value.value', B_AT_BarcodeType, FailureHandling.CONTINUE_ON_FAILURE)
...
WS.verifyElementPropertyValue(rs, 'values.AT_BarcodeFormat.value.value', B_AT_BarcodeFormat, FailureHandling.CONTINUE_ON_FAILURE)
