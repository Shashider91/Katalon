...
B_AT_SchooltexProductType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_SchooltexProductType.value.valueId', B_AT_SchooltexProductType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_FabricContent != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_FabricContent.value.value', B_AT_FabricContent, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_LegalAgeRestriction != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_LegalAgeRestriction.values.valueId', B_AT_LegalAgeRestriction, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_ArtistorAuthor != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_ArtistorAuthor.value.valueId', B_AT_ArtistorAuthor, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_MultimediaPackSize != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_MultimediaPackSize.value.value', B_AT_MultimediaPackSize, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_MultimediaPackSize != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_NewRelease.values.valueId', B_AT_NewRelease, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_NewReleaseExpiryDate != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_NewReleaseExpiryDate.value.value', B_AT_NewReleaseExpiryDate, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_CalculatorType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_CalculatorType.values[0].valueId', B_AT_CalculatorType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_GamingSoftwareType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_GamingSoftwareType.values.valueId', B_GamingSoftwareType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_HeadphoneType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_HeadphoneType.values[0].valueId', B_AT_HeadphoneType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_HPSureSupplySKUCode != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_HPSureSupplySKUCode.value.value', B_AT_HPSureSupplySKUCode, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_OperatingSystem != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_OperatingSystem.values.valueId', B_AT_OperatingSystem, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_PrinterType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_PrinterType.values[0].valueId', B_AT_PrinterType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_SunProtectionFactor != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_SunProtectionFactor.values.valueId', B_AT_SunProtectionFactor, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_WarrantyPeriod != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_WarrantyPeriod.values.valueId', B_AT_WarrantyPeriod, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_WaterResistantCover != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_WaterResistantCover.values.valueId', B_AT_WaterResistantCover, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_DeliveryLocation != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_DeliveryLocation.values.valueId', B_AT_DeliveryLocation, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_CutleryType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_CutleryType.values[0].valueId', B_AT_CutleryType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_DimensionalShape != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_DimensionalShape.values[0].valueId', B_AT_DimensionalShape, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_EnergyEfficiencyRating != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_EnergyEfficiencyRating.values.valueId', 
    B_AT_EnergyEfficiencyRating, FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_FurnitureStyle != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_FurnitureStyle.values.valueId', B_AT_FurnitureStyle, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_HeatingorCooling != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_HeatingorCooling.values.valueId', B_AT_HeatingorCooling, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_HomeFragrance != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_HomeFragrance.values[0].valueId', B_AT_HomeFragrance, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_Mattresstype != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_Mattresstype.values.valueId', B_AT_Mattresstype, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_PrintIndicator != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_PrintIndicator.values.valueId', B_AT_PrintIndicator, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_PrintorPattern != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_PrintorPattern.values[0].valueId', B_AT_PrintorPattern, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_TableandChairSettings != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_Table&amp;ChairSettings.values[0].valueId', 
    B_AT_TableandChairSettings, FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_Usesuitability != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_Usesuitability.values[0].valueId', B_AT_Usesuitability, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_WaterEfficiencyRating != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_WaterEfficiencyRating.values.valueId', B_AT_WaterEfficiencyRating, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_AdditivesType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_AdditivesType.values.valueId', B_AT_AdditivesType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_CleaningAccessoryType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_CleaningAccessoryType.values.valueId', B_AT_CleaningAccessoryType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_EngineOilType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_EngineOil Type.values.valueId', B_AT_EngineOilType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_GPS != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_GPS.values.valueId', B_AT_GPS, FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_OutdoorFurnitureMaterial != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_OutdoorFurnitureMaterial.values[0].valueId', 
    B_AT_OutdoorFurnitureMaterial, FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_PaperorCardType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_PaperorCardType.values.valueId', B_AT_PaperorCardType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_ActivityUse != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_ActivityUse.values[0].valueId', B_AT_ActivityUse, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_BookCoverType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_BookCoverType.values.valueId', B_AT_BookCoverType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_EnvelopeType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_EnvelopeType.values.valueId', B_AT_EnvelopeType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_ExerciseBookLineType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_ExerciseBookLineType.values[0].valueId', 
    B_AT_ExerciseBookLineType, FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_PaintBrushType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_PaintBrushType.values.valueId', B_AT_PaintBrushType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_ReportCoverType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_ReportCoverType.values.valueId', B_AT_ReportCoverType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_RingBinderType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_RingBinderType.values.valueId', B_AT_RingBinderType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_StationeryBookType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_StationeryBookType.values.valueId', B_AT_StationeryBookType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_STEAMSubject != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_STEAMSubject.values[0].valueId', B_AT_STEAMSubject, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_WhiteboardType != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_WhiteboardType.values.valueId', B_AT_WhiteboardType, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_CableConnections != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_CableConnections.values[0].valueId', B_AT_CableConnections, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_ConnectionPort != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_ConnectionPort.values[0].value', B_AT_ConnectionPort, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_IMEIRequired != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_IMEIRequired.values.valueId', B_AT_IMEIRequired, 
    FailureHandling.CONTINUE_ON_FAILURE) : null

B_AT_InkandTonerColours != '' ? WS.verifyElementPropertyValue(rs, 'values."AT_Ink&amp;TonerColours".values[0].valueId', 
    B_AT_InkandTonerColours, FailureHandling.CONTINUE_ON_FAILURE) : null
...
B_AT_TelcoNetwork != '' ? WS.verifyElementPropertyValue(rs, 'values.AT_TelcoNetwork.values[0].valueId', B_AT_TelcoNetwork, 
    FailureHandling.CONTINUE_ON_FAILURE) : null
